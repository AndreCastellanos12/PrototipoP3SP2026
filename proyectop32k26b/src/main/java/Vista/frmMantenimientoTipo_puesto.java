 ...
 * @author ferito
 */
public class frmMantenimientoTipo_puesto extends javax.swing.JInternalFrame {
AplicacionesDAO dao = new AplicacionesDAO(); //inicializar llamada al DAO
    /**
     * Creates new form AplicacionesForm
     */
    public frmMantenimientoTipo_puesto() {
        initComponents();
        llenarTabla();
    ...
    private void initComponents() {
        ...
        tablaAplicaciones.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID tipo_puesto", "Nombre_puesto", "salario"
            }
        ) {
